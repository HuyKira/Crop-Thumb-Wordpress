...
if ( isset( $wp_version ) && version_compare( $wp_version, '3.5' ) >= 0 ) {
	function huykira_image_resize( $url, $width = NULL, $height = NULL, $crop = true, $retina = false ) {
		global $wpdb;
		if ( empty( $url ) )
 ...
 */
add_action( 'delete_attachment', 'huykira_delete_resized_images' );
function huykira_delete_resized_images( $post_id ) {
